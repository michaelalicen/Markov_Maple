...
def make_tiny_dataset():
    ...
    # control setup: v1 is a control candidate for that week/date
    data["ctrl_volunteer"] = ["v1"]
    data["ctrl_week"] = ["2025-11-15"]
    data["ctrl_availability"] = {"v1": {"2025-11-15": True}}
    data["ctrl_qual"] = {"v1": {"active": True}}
